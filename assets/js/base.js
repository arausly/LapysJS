...
itemIndex = 0
    ...
    nav.insertAdjacentHTML('afterbegin',
        ...
        /* Links
                --- FORMAT ---
                    <a class="nav-*" href="<<link>>" hreflang="html" target="_self" title="<<name>>">
                        <span> <<name>> </span>
                        <span class="icn-"> <<icon>> </span>
                    </a>
        */
        '<a class="nav-home" data-title="Home" href="index.html" hreflang="html" target="_self"> <span> Home </span> <span> &#9751; </span> </a>' +
        '<a class="nav-download" data-title="Download" href="download.html" hreflang="html" target="_self"> <span> Download </span> <span> &darr; </span> </a>' +
        '<a class="nav-documentation" data-title="Documentation" href="documentation.html" hreflang="html" target="_self"> <span> Documentation </span> <span> </span> </a>' +
        '<a class="nav-components" data-title="Components" href="components.html" hreflang="html" target="_self"> <span> Components </span> <span> &#9728; </span> </a>' +
        '<a class="nav-class-sets" data-title="Class Sets" href="class-sets.html" hreflang="html" target="_self"> <span> CSS </span> <span> { </span> </a>' +
        '<a class="nav-javascript" data-title="Javascript" href="js.html" hreflang="html" target="_self"> <span> Javascript </span> <span> ( </span> </a>' +
        '<a class="nav-themes" data-title="Themes" href="themes.html" hreflang="html" target="_self"> <span> Themes </span> <span> &#9732; </span> </a>'
    )
    ...
    notify.insertAdjacentHTML('afterend', 
        ...
        '<div id="notify-level">' +
            /* Level and Type of Message
                --- FORMAT ---
                    <a class="level-<<name>>" data-title="<<comment>>" href="updates.html" hreflang="html" style="margin-right: <<+35>>px">
                --- NOTE ---
            ...
            */
            '<a class="level-info p-e-n" data-title="Yo, check this out" href="updates.html" hreflang="html" style="margin-right: 0"> </a>' +
            '<a class="level-valid o-1" data-title="Awesome updates available!" href="updates.html" hreflang="html" style="margin-right: 35px"> </a>' +
            '<a class="level-warn p-e-n" data-title="You might wanna see this..." href="updates.html" hreflang="html" style="margin-right: 70px"> </a>' +
        '</div>'
    )
