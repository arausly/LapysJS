...
/* Example JS */
    ...
    for (i = 0; i < get.html('.code').length; i++) {
        ...
        */
        get.html('.code-editor', i).insertAdjacentHTML(
            ...
            // Edit Code Button
            '<button class="code-button code-edit-button" data-index="' + i + '"> Edit Code </button>'
        )
        ...
        */
        get.html(".code", i).insertAdjacentHTML(
            'beforeend',
            '<textarea class="code-content" data-index="' + i + '" spellcheck="false">' +
    ...
    // Code Buttons
        ...
        // Edit
        for (i = 0; i < get.html('.code-edit-button').length; i++)
            // Add the event
            get.html('.code-edit-button', i).onclick = function() {
                if (!bin) {
                    // Show the code editor
                    get.html('.code-content[data-index="' + get.attr(this, "data-index") + '"]', 0).style.bottom = "0"
                    get.html('.code-content[data-index="' + get.attr(this, "data-index") + '"]', 0).style.position = "relative"
                } else {
                    get.html('.code-content[data-index="' + get.attr(this, "data-index") + '"]', 0).style.bottom = "-1000px"
                    get.html('.code-content[data-index="' + get.attr(this, "data-index") + '"]', 0).style.position = "fixed"
                }
    ...
    // Content
        // Synchronize the content and the preview
        ...
        // Change the preview when this event is fired.
        function editPreview() {
            get.html('.code-preview[data-index="' + get.attr(this, 'data-index') + '"]', 0).innerHTML = this.value
        }
...
/* Aside JS */
    ...
    for (i = 0; i < get.html('#main > .section > .header').length; i++) {
        ...
        get.html('#main-nav', 0).insertAdjacentHTML(
            'beforeend',
            '<li data-title="' + get.html('#main > .section > .header', i).innerHTML + '_left_top" id="' + get.attr(get.html('#main > .section > .header', i), "id") + '"> ' +
